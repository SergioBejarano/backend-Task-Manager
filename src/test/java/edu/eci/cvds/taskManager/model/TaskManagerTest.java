...
class TaskManagerTest {
    ...
    void addTask_ShouldAddTaskToManager() {
        Task task = new Task("1", "Test task", false,  DifficultyLevel.MEDIUM, 3, 5);
    ...
    void addTask_ShouldOverwriteExistingTaskWithSameId() {
        Task task1 = new Task("1", "Test task 1", false,  DifficultyLevel.LOW, 1, 0);
        Task task2 = new Task("1", "Test task 2", true,  DifficultyLevel.HIGH, 3, 5);
        ...
        assertEquals(DifficultyLevel.HIGH, retrievedTask.getDifficultyLevel(), "Difficulty level should be from the second task");
    ...
    void addTask_ShouldIncreaseTaskCount() {
        Task task1 = new Task("1", "Test task 1", false,  DifficultyLevel.LOW, 1, 0);
        Task task2 = new Task("2", "Test task 2", false,  DifficultyLevel.LOW, 1, 0);
    ...
    void addTask_ShouldThrowExceptionForTaskWithNullId() {
        Task taskWithNullId = new Task(null, "Test task", false,  DifficultyLevel.LOW, 1, 0);
    ...
    void addTask_ShouldThrowExceptionForInvalidPriority() {
        Task taskWithInvalidPriority = new Task("3", "Test task with invalid priority", false, DifficultyLevel.MEDIUM, 6, 5);
        ...
        Task task1 = new Task("3", "Test task with invalid priority", false, DifficultyLevel.MEDIUM, -1, 5);
    ...
    void addTask_ShouldThrowExceptionForNegativeAverageDevelopmentTime() {
        Task taskWithNegativeTime = new Task("4", "Test task with negative time", false, DifficultyLevel.LOW, 1, -1);
